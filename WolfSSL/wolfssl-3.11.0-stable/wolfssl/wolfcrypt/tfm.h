...
2021-05-13: Added defines to determine FP_MAX_BITS - to support build process

*/

//#define ADM_CRYPT // Enable for ADC - see connectToAdc() in AlarmControl.c
#define LCM_CRYPT // Enable for LCM - check into github this way please
